    ...
    <LearningLayout>
      <section className="min-w-0 flex-[7]">
        ...
        <div className="mb-4 flex max-w-[940px] flex-wrap items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="w-44">
              ...
              >
                <SelectTrigger variant="bordered" icon={BookOpen} placeholder="选择课文..." className="h-8 text-xs [&_svg]:size-3.5" />
        ...
        <div className={TABLE_SHELL_CLASS}>
          ...
          <Table containerClassName={cn(TABLE_CONTAINER_CLASS, expandedWordId && "overflow-x-hidden")} className="min-w-[1248px] table-fixed border-separate border-spacing-0 [&_td]:border-b [&_td]:border-border/40 [&_th]:border-b [&_th]:border-border/40 [&_tr:last-child_td]:border-b-0">
          <colgroup>
            <col style={{ width: 56 }} />
            <col style={{ width: 144 }} />
            <col style={{ width: 288 }} />
